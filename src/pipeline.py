...
class UnifiedEventProcessor:
    def __init__(self, config_path: str = "config/config.yaml"):
        ...
        self.pipeline_mode = str(
            inference_cfg.get("pipeline_mode", "segformer_yolov8_depthv2_fusion")
        ).lower()
        ...
        self.segformer_yolo_depth_pipeline = get_segformer_yolo_depthv2_pipeline()
