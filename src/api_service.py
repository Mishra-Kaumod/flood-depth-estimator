...
class FloodApiService:
    ...
    def _pipeline_evidence(self, result_payload: dict[str, Any]) -> dict[str, Any]:
        ...
        return {
            ...
            "low_water_gate_applied": structured.get("low_water_gate_applied"),
            "low_water_gate_reason": structured.get("low_water_gate_reason"),
            "model_agreement_status": structured.get("model_agreement_status"),
            "model_agreement_depth_cm": structured.get("model_agreement_depth_cm"),
            "final_aggregation_source": structured.get("final_aggregation_source"),
            "final_output_reason": structured.get("final_output_reason"),
            "residual_fusion_status": structured.get("residual_fusion_status"),
            "pre_residual_fusion_depth_cm": structured.get("pre_residual_fusion_depth_cm"),
            "residual_fusion_depth_cm": structured.get("residual_fusion_depth_cm"),
            "residual_fusion_delta_cm": structured.get("residual_fusion_delta_cm"),
            "model_signals": structured.get("model_signals"),
