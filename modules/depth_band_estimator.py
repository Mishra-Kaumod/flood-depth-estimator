"""
DEPTH BAND ESTIMATOR

Maps flood severity classification to estimated water depth.
"""
...
def estimate_depth(severity):
    """
    Convert severity class to depth estimation.
    
    Args:
        severity (int): Severity class 0-4
...
if __name__ == "__main__":
    for severity in range(5):
        print(f"Severity {severity}: {estimate_depth(severity)}")
